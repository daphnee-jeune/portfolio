            ...
            <div className="subTitle">About</div>
                <section className="about-me">
                    ...
                    <p className="description">
                        ...
                        <br />
                        <br />
                        Using the industry's latest trends, I want to collaborate with a team to create fast, responsive, and dynamic web applications and enhance the user experience.  
                    </p>
                </section>
                <a href="mailto:daphneejeune.dev@gmail.com"  rel="noopener noreferrer" target="_blank" className="contact-me">Let's Get In Touch</a>
                <a rel="noopener noreferrer" target="_blank" href={resume} className="resume">View Resumé</a>
            </div>
    )
}
